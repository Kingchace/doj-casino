			...
			RenderScriptCams(true, 900, 900, true, false)
				...
				CreateThread(function()
					while selectedSlot ~= nil do
						exports['qb-core']:DrawText("Stand up: Backspace</p>Spin: Enter/Space</p>Change View: E")
						QBCore.Functions.TriggerCallback('doj:server:whiteChipsAmount', function(result)
							exports['casinoUi']:DrawCasinoUi("Diamond Casino Slot Machines</p>Availble chips: "..result)   
						end)
						Wait(0)
